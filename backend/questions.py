...
questions = { 
    ...
    [
        ...
        {"source": 5, "option_id": 11, "option_label": "Basic (£650)", "target": 4, "variables": ["rent", "wellbeing"], "amount": [650, -3]},
        {"source": 5, "option_id": 12, "option_label": "Intermediate (£800)", "target": 4, "variables": ["rent", "wellbeing"], "amount": [800,1]},
        {"source": 5, "option_id": 13, "option_label": "Fancy (1100)", "target": 4, "variables": ["rent", "wellbeing"], "amount": [1100,3]},

        {"source": 6, "option_id": 14, "option_label": "Cycle (Initial bike cost £200) [worst wellbeing wise]", "target": 3, "variables": ["transport", "purchase", "wellbeing"], "amount": [0, 200,-3]},
        {"source": 6, "option_id": 15, "option_label": "Public transport (monthly ticket cost of £50 and no maintenance)", "target": 3, "variables": ["transport", "purchase", "wellbeing"], "amount": [50, 0,-1]},
        {"source": 6, "option_id": 16, "option_label": "Buy Car (large initial cost £8k, maintenance £30 and insurance 50)", "target": 3, "variables": ["transport", "purchase", "wellbeing"], "amount": [80, 8000,3]},
        {"source": 6, "option_id": 17, "option_label": "Lease Car (monthly cost £380, maintenance £30 and insurance 50)", "target": 3, "variables": ["transport", "purchase", "wellbeing"], "amount": [450, 0,3]},
        ...
        {"source": 12, "option_id": 30, "option_label": "No holiday", "target": 11, "variables": ["extras", "wellbeing"], "amount": [0,-3]},
        {"source": 12, "option_id": 31, "option_label": "Small holiday (£400/year)", "target": 11, "variables": ["extras", "wellbeing"], "amount": [34,-1]},
        {"source": 12, "option_id": 32, "option_label": "Medium holiday (£800/year)", "target": 11, "variables": ["extras", "wellbeing"], "amount": [67,1]},
